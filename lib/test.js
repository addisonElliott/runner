...
// Also dont forget that mongodb-topology-manager checkForAvailable can be converted to use promises
// Also, server is a bit slow to start and I think it's because of the retry/timeout thing.